...
- This project led to many contributions to the [MyST] project provides a collection of tools for working with MyST Markdown. MyST is part of [Project Jupyter](https://jupyter.org), and is open source and [publicly available on GitHub](https://github.com/jupyter-book/mystmd).
...
3. **Talks** - Engage with journal editors and data editors to seek feedback and collaboration, to get a better sense of how our project can streamline review process, ensure reproducibility, and enhance the credibility of published research.
